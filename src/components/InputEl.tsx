...
const InputEl = ({label, placeholderText,register, id,type,imagePath,isError,labelText, ...rest }:Props) => {
  return (
    <div>
      ...
      <div className={`flex px-4 py-[.75rem] items-center space-x-[.75rem] rounded-md border ${isError ? 'border-[#FF3939]' : 'border-[#D9D9D9]' }   focus-within:border-2 focus-within:border-[#633CFF] focus-within:shadow-lg focus-within:shadow-[rgba(133,121,179,0.25)]`}>
