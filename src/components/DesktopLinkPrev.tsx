...
export default function DesktopLinkPrev() {
  return (
    <div className=" bg-white rounded-lg shadow-sm p-[1.5rem] sm:p-[2.5rem] hidden xl:flex xl:items-center xl:justify-center flex-1">
      <div className="w-[19.1875rem] min-h-[39.4375rem] flex flex-col border border-[#737373] rounded-[3rem] p-[.69rem] ">
